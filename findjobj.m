                ...
                elseif ~isgraphics(origContainer,'figure') && ~isempty(hFig)
                    ...
                    try
                        ...
                        try
                            ...
                            if strcmpi(get(hFig,'NumberTitle'),'on')
                    ...
                    if ~isempty(pos)
                        if isgraphics(container,'uicontrol') && strcmp(get(container,'style'),'popupmenu')
...
%}
        ...
        set(handle(hModel,'CallbackProperties'), 'TableChangedCallback',@tbCallbacksChanged);
    ...
    function nodeSelected(src, evd, tree)  %#ok
        try
            ...
            try
                ...
                userdata = get(src.java,'userdata');
            end
                ...
                if (numSelections == 1)
                    ...
                    if ~userdata.inInit
                        ...
                        try
                            ...
                            set(src.java,'userdata',userdata);
                        end
                    end
