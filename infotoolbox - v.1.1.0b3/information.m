...
%INFORMATION Compute mutual information and information-like quantities.
%
%   ------
%   SYNTAX
%   ------
...
%       | 'G2'    | I(R1,R2;S) - I(R1;S)
%       |---------------------------------------------------------------|
%       | 'GMAX'  | I(R1,R2;S) - max(I(R1;S), I(R2;S))
%       =================================================================
%
...
%       array of length Opt.btsp concatenated to the actual information
%       estimate. For example, suppose that I is computed with Opt.btsp =
%       20. In this case the output corresponding to I will be an array
