...
%%% pub %%% e.g. NE
structMyArgument = deleteFromArgumentAndGetValueAM(varargin,'pub');
...
if booleanValidFigure %If we have a valid Figure  go on....
    ...
    structMyArgument = deleteFromArgumentAndGetValueAM(varargin,'format');
    if ~isempty(structMyArgument.value)
...
if pptOutputVersion == 2
    ...
    myArgumentsImagePNG.defaultMagnify        = 1;
...
switch pptOutputVersion
    case 1 % Vector output
        try
            ...
            myArgumentsImageVEC.defaultMagnify = 1;
...
function myArg = getValuesFromArgument(myArg,arguments,out)
    ...
    if strcmp(out,'vec') || strcmp(out,'png')
        ...
        %%% Position %%% e.g. NE
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'pos');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'gapN');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'gapS');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'gapWE');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'divide');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'SlideNumber');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'SlideAddMethod');
        if ~isempty(structMyArgument.value)
        ...
        %%% Height %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'Height');
        if ~isempty(structMyArgument.value)
        ...
        %%% Width %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'Width');
        if ~isempty(structMyArgument.value)
        ...
        %%% Top %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'Top');
        if ~isempty(structMyArgument.value)
        ...
        %%% Left %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'Left');
        if ~isempty(structMyArgument.value)
    ...
    if strcmp(out,'text')
        ...
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'applyTemplate');
        if ~isempty(structMyArgument.value)
        ...
        % to save the data
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'savePath');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'close');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'saveFilename');
        if ~isempty(structMyArgument.value)
        ...
        %%% setTitle %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'setTitle');
        if ~isempty(structMyArgument.value)
        ...
        %%% setBulletNumbers %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'setBulletNumbers');
        if ~isempty(structMyArgument.value)
        ...
        %%% setBullets %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'setBullets');
        if ~isempty(structMyArgument.value)
        ...
        %%% setTable %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'setTable');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument               = deleteFromArgumentAndGetValueAM(arguments,'TeX');
        if ~isempty(structMyArgument.value)
        ...
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'setTableS');
        if ~isempty(structMyArgument.value)
            myArg.defaultTable         = structMyArgument.value;
            arguments                  = structMyArgument.arguments;
            myArg.doSetTable           = 1;
        ...
        %%% setTable %%%
        structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'setHyperLink');
        if ~isempty(structMyArgument.value)
    ...
    switch out
        case 'vec'
            ...
            %AutoGroupMin
            structMyArgument = deleteFromArgumentAndGetValueAM(arguments,'AutoGroupMin');
            if ~isempty(structMyArgument.value)
        ...
        case 'png'
            ...
            %%% magnify %%%
            structMyArgument       = deleteFromArgumentAndGetValueAM(arguments,'m');
            if ~isempty(structMyArgument.value)
